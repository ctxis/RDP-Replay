...
//SE	if (channelCount != settings->num_channels)
//SE	{
//SE		printf("requested %d channels, got %d instead\n",
//SE				settings->num_channels, channelCount);
//SE	}

	for (i = 0; i < channelCount; i++)
	{
		stream_read_uint16(s, channelId); /* channelId */
//SE		settings->channels[i].channel_id = channelId;
	}

...
if (0==bitmap && trace_ord) printf("WOAH: BAD BITMAP: cache Id=%d, Index=%d\n", (int)(memblt->cacheId), (int)(memblt->cacheIndex)) ;//SE
...
rdpBitmapCache* bitmap_cache_new(rdpSettings* settings)
{
	...
	if (bitmap_cache != NULL)
	{
		...
		settings->bitmapCacheV2CellInfo[2].numEntries = 3048;

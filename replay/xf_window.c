...
//SE #include "FreeRDP_Icon_256px.h"
//SE #define xf_icon_prop FreeRDP_Icon_256px_prop
#include "context_icon.h" //SE
#define xf_icon_prop Context_Icon_256px_prop //SE
...
XResizeWindow(xfi->display, window->handle, width, height) ;//SE
}
